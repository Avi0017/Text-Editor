...
public:
    ...
    { // this function will add to Head
    ...
    { // an extra function used to add to tail, had to implement to make Undo function work, ignore this one please
    ...
    { // an extra function used to delete from tail, had to implement to make Undo function work,ignore this one please
    ...
    void deleteHead()
    { // function used to delete the very first element, and update the head
    ...
    { // this function will insert text in the given line, and will push all the other lines
    ...
    { // this function will overwrite anything written in the given line
    ...
    { // this function should delete anything in the given line, also decreases the numOfLines
